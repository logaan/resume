...
\begin{resume}                        
  ...
  \item Hackless
  \item Houston
  \item Bringing in rails
  \item Bringing in SVN and then Git
  \item Writing new CMS
  \item Client sites
  \end{itemize} 
  ...
  \begin{multicols}{2}
    ...
    Intro to Erlang, A Monad is not a Burrito, Clojure Workshop, Promise Streams,
    OO values in FP languages, Clojure at a Post Office, Intro to Elixir, Full
    Stack development with FP (Panel)
