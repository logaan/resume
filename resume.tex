...
\begin{resume}
  ...
  \begin{multicols}{2}
    ...
    Haskell, Kotlin, Java, Javascript, Lua, \\
    PHP, Python, ReasonML, Ruby, Rust, \\
    Scala, Typescript, VB Script
    ...
    \textbf{Tools} \\
    Kubernetes, RabbitMQ, AWS, Cassandra, Datomic, Docker, Heroku, Kafka,
    Postgres, MySQL \\
  ...
  \begin{itemize}
  \item Technical lead for the back end implementation of Pay As You Go with no
  payment up front (Kotlin, Python)
  \end{itemize}
